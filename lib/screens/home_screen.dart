...
class _S extends State<HomeScreen> {
  ...
  bool get _open {
    if (_now.weekday == DateTime.saturday || _now.weekday == DateTime.sunday) return false;
    final tot = _now.hour * 60 + _now.minute;
    return tot >= MARKET_OPEN_HOUR * 60 + MARKET_OPEN_MIN &&
        tot < MARKET_CLOSE_HOUR * 60 + MARKET_CLOSE_MIN;
  }

  bool get _best {
    final tot = _now.hour * 60 + _now.minute;
    return tot >= BEST_ENTRY_HOUR * 60 + BEST_ENTRY_MIN &&
        tot < EXIT_WARNING_HOUR * 60 + EXIT_WARNING_MIN;
  }

  // Fix #2 — proper string interpolation, no backslash escaping
  String get _time =>
  ...
  Widget build(BuildContext ctx) => Scaffold(
    ...
    body: SafeArea(child: Column(children: [
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text(_open ? 'MARKET OPEN' : 'MARKET CLOSED',
                  style: TextStyle(
                      color: _open ? const Color(COLOR_GREEN) : Colors.red,
      ...
      Container(
        ...
        child: Row(children: [
          const Text('IST', style: TextStyle(color: Colors.grey, fontSize: 10, letterSpacing: 2)),
          const SizedBox(width: 12),
          Text(_time, style: const TextStyle(color: Colors.white, fontSize: 16,
